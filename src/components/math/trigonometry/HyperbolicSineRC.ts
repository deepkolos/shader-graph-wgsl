...
export type ReteHyperbolicSineNode = ExtendReteNode<
  'HyperbolicSine',
  {
...
export class HyperbolicSineRC extends RC {
  constructor() {
    super('HyperbolicSine');
    this.data.component = NodeView;
  }

  initNode(node: ReteHyperbolicSineNode) {
    ...
    meta.label = 'Hyperbolic Sine';
  }

  async builder(node: ReteHyperbolicSineNode) {
    this.initNode(node);
